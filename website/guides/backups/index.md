...
Backups in **Trinity Launcher** are compatible between different versions of the app.
...
1. Go to **Settings → Periodic Backups**.
2. Set a **backup creation frequency** to schedule automatic backups.
